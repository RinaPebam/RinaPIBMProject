...
/*TC_UNF_78: To verify whether application allows admin to create multiple categories & add product on the created category*/


public class TC_UNF_78{
	...
	@Test(dataProvider = "xls-inputsTC78", dataProviderClass = AllTCsDataProviders.class)
